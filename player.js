...
Player.prototype.draw = function () 
{
    ...
    var iconSizeY = 30;
        ...
        context.drawImage(this.ammoIcon, 10, 15, 40, 40)
        context.fillStyle = "#000";
        context.font = "18px Arial";
        context.fillText("x " + this.ammoCount.toString(), 50, 45);

	// life counter
	for(var i=0; i<lives; i++)
	{
		context.drawImage(this.healthIcon, 120 + ((this.healthIcon.width = 39)*i), 15);
	}
}
